...
# RUN: llvm-mc -filetype=obj -triple=arm64-apple-macosx12.0.0 %t/arm64-dtrace.s -o %t/arm64-dtrace.o
# RUN: %lld -demangle -dynamic -arch arm64 -platform_version macos 12.0.0 12.3 -o %t/arm64-dtrace %t/arm64-dtrace.o
