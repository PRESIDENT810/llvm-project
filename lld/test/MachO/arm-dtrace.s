...
# RUN: llvm-mc -filetype=obj -triple=thumbv7-apple-macosx12.0.0 %t/armv7-dtrace.s -o %t/armv7-dtrace.o
# RUN: %lld -demangle -dynamic -arch armv7 -platform_version macos 12.0.0 12.3 -o %t/armv7-dtrace %t/armv7-dtrace.o
