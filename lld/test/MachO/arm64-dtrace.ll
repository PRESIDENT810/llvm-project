...
; RUN: llvm-as %t/arm64-dtrace.ll -o %t/arm64-dtrace.ll.o
; RUN: %lld -demangle -dynamic -arch arm64 -platform_version macos 12.0.0 12.3 -o %t/arm64-dtrace %t/arm64-dtrace.ll.o
